// importar os comandos para ler os arquivos
...
// lendo os dois arquivos e transformando em json
...
function ler(index){
    switch (index) {
        ...
        break;
        case 4:
            console.log("Amapá - " + cont4)
        break;
        case 5:
            console.log("Bahia - " + cont5)
        break;
        case 6:
            console.log("Ceará - " + cont6)
        break;
        case 7:
        ...
        break;
        case 14:
            console.log("Pará - " + cont14)
        break;
        case 15:
            console.log("Paraíba - " + cont15)
        break;
        case 16:
            console.log("Pernambuco - " + cont16)
        break;
        case 17:
            console.log("Piauí - " + cont17)
        break;
        case 18:
            console.log("Paraná - " + cont18)
        break;
        case 19:
        ...
        break;
        case 26:
            console.log("São Paulo -> " + cont26)
        break;
        case 27:
            console.log("Tacantins - " + cont27)
        break;
    }
}
